@file:Suppress("LeakingThis", "RedundantOverride", "DEPRECATION")
...
abstract class BaseAdapter<T,VH : RecyclerView.ViewHolder>(private var options : FirebaseOptions<T>) : RecyclerView.Adapter<VH>() , BaseInterfaceAdapter<T> {
