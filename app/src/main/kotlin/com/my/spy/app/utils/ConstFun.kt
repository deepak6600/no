@file:Suppress("DEPRECATION", "RedundantSamConstructor", "UnusedImport")
...
import com.my.spy.app.BuildConfig
...
import com.my.spy.app.ui.adapters.basedapter.FirebaseOptions
import com.my.spy.app.ui.fragments.maps.MapsFragment
import com.my.spy.app.ui.widget.toolbar.CustomToolbar
import com.my.spy.app.utils.Consts.APP_DISABLED
import com.my.spy.app.utils.Consts.APP_ENABLED
import com.my.spy.app.utils.Consts.COMMAND_ENABLE_GPS_PROVIDER
import com.my.spy.app.utils.Consts.COMMAND_ENABLE_NETWORK_PROVIDER
import com.my.spy.app.utils.async.AsyncTaskRootPermission
